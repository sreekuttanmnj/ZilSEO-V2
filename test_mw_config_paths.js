...
const variations = [
    'https://ttv.microworkers.com/api/v2/basic_campaign/configuration',
    'https://ttv.microworkers.com/api/v2/basic_campaigns/configuration',
    'https://ttv.microworkers.com/api/v2/basic-campaign/configuration',
    'https://ttv.microworkers.com/api/v2/basic-campaigns/configuration',
    'https://api.microworkers.com/api/v2/basic_campaign/configuration',
